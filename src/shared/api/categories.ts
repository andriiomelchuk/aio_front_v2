import { T_Categories, T_CreateCategoryDto, T_JsonPlaceholderCategory, T_UpdateCategoryDto } from "@/entities/categories/model/types"
...
export const getCategories = async (): Promise<T_Categories[]> =>  {
    ...
    if(!response.ok){
        throw new Error("Failed to fetch categoris ")
    }
